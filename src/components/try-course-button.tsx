  ...
  return (
    <div className="relative inline-block w-[20%] p-1.5">
      ...
      <div className="flex justify-center">
        <button className="relative w-[95%] rounded-full bg-[#eaf7dc] px-12 py-3 text-xl font-bold uppercase text-black shadow-md transition-all duration-300 ease-in-out hover:shadow-lg">
