const CourseTimeline = () => {
  return (
    <div className="flex w-3/4 flex-col items-center rounded-xl bg-white bg-opacity-50 px-[6vw] py-[6vh] text-black dark:bg-devstation-cyan-100 dark:text-devstation-yellow-50">
